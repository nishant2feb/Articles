...
> Both IQR and GESD have their Pros and cons, IQR is compartively faster as 
> there are no loops involved in the IQR but its not as accurate as GESD since > the anomalies skews the median which is removed in GESD.
